...
void write_itype_except_load(Instruction instruction) {
    ...
    switch (instruction.itype.funct3) {
        case 0x0:
            ...
            break;
        case 0x1:{
            unsigned int funct7 = (instruction.itype.imm >> 5) & 0x7F; //Shift the imm part to extract position [5:11]
            if(funct7 == 0x00){
        ...
        case 0x5:{
            unsigned int funct7 = (instruction.itype.imm >> 5) & 0x7F;
            if (funct7 == 0x00){
...
void print_load(char *name, Instruction instruction) {
    ...
    printf(MEM_FORMAT, name, instruction.itype.rd, offset, instruction.itype.rs1);
}
